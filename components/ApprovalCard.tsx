  ...
  return (
    <div className="rounded-2xl border border-amber-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-5 rounded-xl bg-slate-50 p-4">
        <p className="text-sm text-slate-500">Requested action</p>
        <p className="mt-1 font-medium text-slate-950">{approval.tool_name}</p>
      </div>

      <p className="mt-4 text-sm text-slate-600">{approval.reason}</p>
